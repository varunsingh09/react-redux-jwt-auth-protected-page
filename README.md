...
This project is an example of one possible authentication flow using [react]

It is based on the implementation of a [higher-order component]
...
````
1. git clone https://github.com/varunsingh09/react-redux-jwt-auth-protected-page.git
2. npm install
...
# react-redux-jwt-auth-protected-page
